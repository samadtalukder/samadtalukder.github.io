        ...
        <>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <button
                            ...
                            className={`md:hidden shrink-0 p-2 ${isScrolled ? 'text-brand-orange' : 'text-brand-orange'}`}
            ...
            {isMobileMenuOpen && (
                <div className="fixed inset-0 z-40 bg-white md:hidden" role="dialog" aria-modal="true"
                    ...
                    <nav className="flex flex-col items-center justify-center h-full gap-8" role="navigation"
