  ...
  return (
    <section id="services" className="py-16 md:py-20 lg:py-24">
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <p className="text-center text-brand-orange font-medium text-lg mb-2">My Services</p>
            ...
            return (
              <ScrollReveal key={service.title} delay={0.1 * index}>
                <Card className="p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col items-center text-center">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-brand-orange to-brand-orange/90 flex items-center justify-center mb-6">
